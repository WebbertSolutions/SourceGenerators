...
internal static class GenerateBuilder
{
	public static string GetTemplate(GeneratorInformation generatorInformation, string attributeNamespace)
	{
		...
		string builderConstructor = ConstructorGenerator.Generate(interfaceInformation);
...
// ================================================================================
// <auto-generated> {DateTime.Now.ToLongTimeString()}
//
...
{builderConstructor}
    ...
    public static {classInformation.ClassName} Default(string json)
    {{
    ...
    public static {classInformation.ClassName} Default({interfaceInformation!.ClassName} obj)
    {{
        return new {classInformation.ClassName}();
    }}
